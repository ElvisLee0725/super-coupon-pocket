...
const PrivacyPolicy = () => {
  return (
    <div className='container my-5'>
      ...
      <p>
        At Super Coupon Pocket, accessible from scp.elvislee.com, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        Super Coupon Pocket and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Super Coupon Pocket. This policy is not
      ...
      <p>
        Super Coupon Pocket follows a standard procedure of using log files.
      ...
      <p>
        ...
        advertising partners of Super Coupon Pocket.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Super Coupon Pocket, which are
      ...
      <p>
        Note that Super Coupon Pocket has no access to or control over these
      ...
      <p>
        Super Coupon Pocket&apos;s Privacy Policy does not apply to other
      ...
      <p>
        Super Coupon Pocket does not knowingly collect any Personal Identifiable
