  ...
  return (
    <div className='container page-container my-5'>
      ...
      <p className='mb-3'>
        ...
        and use of the scp.elvislee.com website as well as any other media form,
        ...
        YOU MUST DISCONTINUE USE IMMEDIATELY. Supplemental terms and conditions
        ...
        local laws, if and to the extent local laws are applicable. The Site is
      ...
      <p>
        ...
        username is inappropriate, obscene, or otherwise objectionable. Your
        password is encrypted before storing to our database
      </p>
      ...
      <p>
        ...
        endorsed or approved by us. As a user of the Site, you agree not to: 1.
        ...
        directory without written permission from us. 2. Trick, defraud, or
        mislead us and other users, especially in any attempt to learn sensitive
        account information such as user passwords. 3. Circumvent, disable, or
        ...
        contained therein. 4. Disparage, tarnish, or otherwise harm, in our
        opinion, us and/or the Site. 5. Use any information obtained from the
        Site in order to harass, abuse, or harm another person. 6. Engage in
        unauthorized framing of or linking to the Site. 7. Upload or transmit
        ...
        functions, operation, or maintenance of the Site. 8. Engage in any
        ...
        and extraction tools. 9. Delete the copyright or other proprietary
        rights notice from any Content. 10. Attempt to impersonate another user
        or person or use the username of another user. 11. Upload or transmit
        ...
        or “pcms”). 12. Interfere with, disrupt, or create an undue burden on
        the Site or the networks or services connected to the Site. 13. Attempt
        to bypass any measures of the Site designed to prevent or restrict
        access to the Site, or any portion of the Site. 14. Copy or adapt the
        Site’s software, including but not limited to Flash, PHP, HTML,
        JavaScript, or other code. 15. Decipher, decompile, disassemble, or
        reverse engineer any of the software comprising or in any way making up
        a part of the Site. 16. Except as may be the result of standard search
        ...
        using or launching any unauthorized script or other software. 17. Use a
        buying agent or purchasing agent to make purchases on the Site. 18. Make
        ...
        or under false pretenses. 19. Use the Site as part of any effort to
      ...
      <p>
        ...
        available any Contributions, you thereby represent and warrant that: 1.
        ...
        anyone. 8. Your Contributions are not used to harass or threaten (in the
        legal sense of those terms) any other person and to promote violence
        against a specific person or class of people. 9. Your Contributions do
        not violate any applicable law, regulation, or rule. 10. Your
        Contributions do not violate the privacy or publicity rights of any
        third party. 11. Your Contributions do not contain any material that
        ...
        of minors. 13. Your Contributions do not include any offensive comments
        that are connected to race, national origin, gender, sexual preference,
        or physical handicap. 14. Your Contributions do not otherwise violate,
      ...
      <p>
        ...
        Policy: scp.elvislee.com/privacy-policy. By using the Site, you agree to
      ...
      <h3>Modification and interruptions</h3>
      <p>
      ...
      <p>
        ...
        Arbitration If the Parties are unable to resolve a Dispute through
        informal negotiations, the Dispute (except those Disputes expressly
        excluded below) will be finally and exclusively resolved through binding
        ...
        Disputes (&quot;AAA Consumer Rules&quot;), both of which are available
        ...
        will take place in Orange, California. Except as otherwise provided
        ...
        judgment on the award entered by the arbitrator. If for any reason, a
        ...
        Orange, California, and the Parties hereby consent to, and waive all
        ...
        Transaction Act (UCITA) is excluded from these Terms of Use. If this
